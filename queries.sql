...
HAVING AVG(e.salary) > (SELECT avg_company_salary FROM company_avg)
...
INSERT INTO certifications (name, issuing_org, level) VALUES
    ...
    ('Python for Data Science', 'Coursera', 'Intermediate'),
    ('Project Management Professional', 'PMI', 'Advanced'),
    ('Google Data Analytics', 'Google', 'Beginner'),
    ('Certified Kubernetes Administrator', 'CNCF', 'Advanced');
